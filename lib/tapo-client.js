    ...
    const thisOp = prevOp.then(async () => {
        ...
        if (!cached || Date.now() >= cached.expiresAt) {
            ...
            try {
                ...
                if (/ERR_SSL_WRONG_VERSION_NUMBER|ssl3_get_record|wrong version number/i.test(authErr.message)) {
        ...
        try {
            ...
            if (/ERR_SSL_WRONG_VERSION_NUMBER|ssl3_get_record|wrong version number/i.test(err.message)) {
